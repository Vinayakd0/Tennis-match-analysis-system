...
from avi_to_mp4 import convert_to_mp4
...
def main():
    ...
    ball_tracker = BallTracker(model_path='model/ball_detections.pt')
    ...
    convert_to_mp4("output_videos/output_video.avi","output_videos/output_video.mp4")
